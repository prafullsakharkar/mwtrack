...
function ShotInfo(props) {
    ...
    return (
        <CardContent>
            ...
            <div className="mb-24">
                <Typography className="font-bold mb-4 text-15">Start Frame</Typography>
                <Typography className="font-medium" color="text.secondary">{data.start_frame}</Typography>
            </div>
            <div className="mb-24">
                <Typography className="font-bold mb-4 text-15">End Frame</Typography>
                <Typography className="font-medium" color="text.secondary">{data.end_frame}</Typography>
            </div>
            <div className="mb-24">
